...
class VideoCallingScreen extends StatefulWidget {
  ...
  VideoCallingScreen(
      ...
      required this.token,
      required this.resCallRequestModel,
      required this.resCallAcceptModel,
      required this.isForOutGoing});
...
class _VideoCallingScreenState extends State<VideoCallingScreen> {
        ...
        child: Opacity(
          ...
          child: Row(
            children: [
              ...
              TimerView(
                key: _timerKey, updateTimerStatus: (){},
              )
            ],
          ),
        ),
  ...
  void _onCallEnd(BuildContext context) async {
    ...
    NavigationUtils.pushAndRemoveUntil(
      context,
      RouteConstants.routeCommon, arguments: '',
    );
  }
}
